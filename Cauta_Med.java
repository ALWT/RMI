	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        { 
			...
			{  
				...
				//DBManageReal db = new DBManageReal("localhost","pad_bd","root","");
	            ...
	            {  	
	            	...
	            	if(fl != null)
            		{
            			...
            			else
            			{
							...
							String aux="<button class=\"btn btn-dark\" style=\"margin-left: 1200px\" onClick=\"buymedicament('"+med.getNume()+"');\">Adauga in WishList "+med.getPret()+" Ron"+s.getDbase()+"</button>";
